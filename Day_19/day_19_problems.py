...
will be expressed relative to scanner 0 (using the orientation of scanner 0
and as if scanner 0 is at coordinates 0,0,0).
...
infile = sys.argv[1] if len(sys.argv) > 1 else "Day_19/input.txt"
